...
st.set_page_config(
    ...
    page_icon="imgs/ahsankarya2.ico",
    layout="wide",
    initial_sidebar_state="auto",
    menu_items={
        "Get help": "https://github.com/fathannaufalahsan",
...
def initialize_conversation():
    ...
    """
    assistant_message = "Hello! I am Ahsan. How can I assist you today?"
...
def main():
    ...
    if not st.session_state.history:
        initial_bot_message = "Hello! How can I assist you with Ahsan today?"
    ...
    if show_basic_info:
        st.sidebar.markdown("""
        ### Basic Interactions
        - **Ask About Ahsan**: Type your questions about Ahsan latest updates, features, or issues.
        - **Search for Code**: Use keywords like 'code example', 'syntax', or 'how-to' to get relevant code snippets.
        - **Navigate Updates**: Switch to 'Updates' mode to browse the latest Ahsan updates in detail.
        """)
    ...
    if show_advanced_info:
        ...
        - **Generate an App**: Use keywords like **generate app**, **create app** to get a basic Ahsan app code.
        - **Code Explanation**: Ask for **code explanation**, **walk me through the code** to understand the underlying logic of Ahsan code snippets.
        - **Project Analysis**: Use **analyze my project**, **technical feedback** to get insights and recommendations on your current Ahsan project.
        - **Debug Assistance**: Use **debug this**, **fix this error** to get help with troubleshooting issues in your Ahsan app.
        """)

    st.sidebar.markdown("---")

    # Load and display image with glowing effect
    img_path = "imgs/ahsankarya.png"
    img_base64 = img_to_base64(img_path)
    if img_base64:
        st.sidebar.markdown(
            f'<img src="data:image/png;base64,{img_base64}" class="cover-glow">',
